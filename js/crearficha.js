function edit_row(no) {
    ...
    var tarea_data = tarea.innerHTML;
    var tutor_data = tutor.innerHTML;
    var empresa_data = empresa.innerHTML;
    semana.innerHTML = "<input type='week' id='semana_text" + no + "' value='" + semana_data + "'>";
    dia.innerHTML = "<input type='date' id='dia_text" + no + "' value='" + dia_data + "'>";
